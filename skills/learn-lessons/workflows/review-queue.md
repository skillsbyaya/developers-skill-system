...
- **Keep unresolved** — evidence, intended behaviour, ownership, or a safe prevention remains unclear.
...
2. Prefer the existing owner that can prevent the cause. Test whether the exact prevention would have changed the recorded failure without burdening a neighbouring case.
