...
- Follow project instructions and established code conventions. Load project context only when project facts, current delivery state, or known hazards could change the answer. Reuse unchanged guidance already read in this context; a workflow transition alone does not require another read.
